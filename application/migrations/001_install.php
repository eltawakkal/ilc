...
/*
	...
	private function _table_admin_role()
    {
        if(!$this->db->table_exists('admin_role'))
        {
            ...
            $this->dbforge->add_key('id', true);
            $this->dbforge->create_table('admin_role', true);
            ...
            $this->db->insert_batch('admin_role', $records);
