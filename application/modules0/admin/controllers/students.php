...
class students extends MX_Controller {
	...
	static function send_msg(){
		...
		if(isset($_FILES['messages_attach']['name']) && !empty($_FILES['messages_attach']['name'])){
		 ...
		 (messages_title,messages_text,messages_from,messages_to,messages_from_view,messages_to_view,messages_attach,message_created_on) values('$messages_title','$messages_text','$admin_guid','$messages_to','0','0','$messages_attach','$messages_created_on')");
