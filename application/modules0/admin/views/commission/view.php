								...
								<div class="panel-heading">
							     ...
							     <div class="form-group">
									<label for="exampleInputEmail_4" class="col-sm-4 control-label" style="top: 18px; font-size: 15px !important">Commission</label>
									 <div class="col-sm-5">
									  <input class="form-control" placeholder="Enter commission" id="users_accured_com" name="users_accured_com" type="text" >
									 </div>
								 </div>
								 ...
								 <br><br>
								  ...
								  <div class="form-group">
									<label for="exampleInputEmail_4" class="col-sm-4 control-label" style="top: 18px; font-size: 15px !important">Payment</label>
									 <div class="col-sm-5">
									  <input class="form-control" id="users_redeemed" name="users_redeemed" placeholder="Enter program"   type="text" >
									 </div>
								 </div>
								 <br><br>
								  <div class="form-group">
