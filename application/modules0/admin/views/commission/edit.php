                        ...
                        <form id="fas_form" method="post" enctype="multipart/form-data"  action="">
							 <div class="form-horizontal">					   			 
                                ...
                                <div class="form-group">
									 ...
									 <div class="col-sm-8">
									 <input class="form-control" placeholder="Enter email" name="admin_email" id="admin_email" type="text" value="<?php echo $agents->admin_email ?>" />
									 </div>
								 </div>
                                ...
                                <div class="form-group">
								 ...
								 <div class="form-group">
								  ...
								  <div class="form-group" >
									 ...
									 <div class="col-sm-8">
									 <input class="form-control" id="agents_bank_address" name="agents_bank_address" placeholder="Enter bank address" value="<?php echo $agents->agents_bank_address ?>" type="text"  >
									 </div>
								 </div>
