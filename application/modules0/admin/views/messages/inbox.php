							...
							<div class="mail-box">
								<div class="row">
									...
									<li class="active" role="presentation" style="margin-bottom:0px !important">
										<a aria-expanded="true"  data-toggle="tab" role="tab" id="home_tab_8" href="#home_8" style="background: #fff;"><i class="zmdi zmdi-inbox"></i> Inbox <span class="label label-danger ml-10">2</span></a></li>
												...
												<div class="panel-body inbox-body pa-0">
												 ...
												 <?php if(isset($inbox)):?>
                            						<?php $ff=''; $i=1;foreach ($inbox as $new){
																if($new->messages_from_view == 0){$ff='class="unread"'; } else {$ff='';}?>
														...
														<tr <?php echo $ff;?>></tr>
															...
															<td class="view-message  dont-show">
																<a href="<?php echo site_url('admin/students/details/'.$new->messages_id); ?>">
																	<?php echo $new->users_fullname ?><span class="label label-warning pull-right">new</span></a></td>
												 ...
												 <?php if(isset($send)):?>
                            						<?php $ff=''; $i=1;foreach ($send as $new){
														...
														<tr <?php echo $ff;?>></t>
															...
															<td class="view-message  dont-show"><?php echo $new->users_fullname ?><span class="label label-warning pull-right">new</span></td>
															<td class="view-message "><?php echo $new->messages_title ?></td>
															<td class="view-message  text-right">
