						 ...
						 <div class="form-horizontal input_fields_wrap">
							 <div class="form-group">
								 <label for="exampleInputuname_4" class="col-sm-2 control-label">University</label>
								    <div class="col-sm-4">
									 <input class="form-control" name="receipts_university" type="text" placeholder="Enter university" required >
							        </div>
							 </div>
                             <div class="form-group">
							 ...
							 <div class="form-group">
								 <label for="exampleInputuname_4" class="col-sm-2 control-label">Fund  status</label>
								    <div class="col-sm-4">
							 ...
							 <div class="form-group">
								 <label for="exampleInputuname_4" class="col-sm-2 control-label">Fund</label>
								    <div class="col-sm-2">
									 <input class="form-control" name="receipts_fund" type="text" placeholder="Enter fund" required >
							        </div>
							 </div>
