<link href="<?php echo base_url('assets/cp/vendors/bower_components/jasny-bootstrap/dist/css/jasny-bootstrap.min.css')?>" rel="stylesheet" type="text/css"/>
    ...
    margin-right: -9px;">
								<div class="panel-heading">
									<div class="pull-left">
										<h6 class="panel-title txt-dark">Edit financial details</h6>
									</div>
                        ...
                        <form id="fas_form" method="post" enctype="multipart/form-data"  action="">
							 <div class="form-horizontal">					   			 
                                ...
                                <div class="form-group">
									 ...
									 <div class="col-sm-8">
									 <input class="form-control" placeholder="Enter eamil" name="admin_email" id="admin_email" type="text" value="<?php echo $agents->admin_email ?>" />
									 </div>
								 </div>
                                ...
                                <div class="form-group">
									 ...
									 <div class="col-sm-8">
									 <input class="form-control" placeholder="Enter confirm password" name="admin_confirm" id="admin_confirm" type="password"  />
									 </div>
								 </div>
                               ...
                               <div class="form-group ">
									...
									<?php $com=''; $in=''; if($agents->agents_apply_for == 1){ $com='selected="selected"'; $in='';} else {$com=''; $in='selected="selected"';} ?>
                             ...
                             <div class="form-group" id="fullname">
									 ...
									 <div class="col-sm-8">
									 <input class="form-control" placeholder="Enter full name" name="agents_fullname" id="agents_fullname" type="text" value="<?php echo $agents->agents_fullname ?>"  />
									 </div>
								 </div>
								 ...
								 <div class="form-group" id="company_name">
									 ...
									 <div class="col-sm-8">
									 <input class="form-control" placeholder="Enter company name" name="agents_company_name" id="agents_company_name" type="text" value="<?php echo $agents->agents_company_name ?>"/>
									 </div>
								 </div>
								 ...
								 <div class="form-group" id="type_business">
									 ...
									 <div class="col-sm-8">
									 <input class="form-control" placeholder="Enter type busniess" name="agents_type_business" id="agents_type_business" type="text"  value="<?php echo $agents->agents_type_business ?>"/>
									 </div>
								 </div>
								 ...
								 <div class="form-group" id="position">
									 ...
									 <div class="col-sm-8">
									 <input class="form-control" placeholder="Enter position" name="agents_position" id="agents_position" type="text"  value="<?php echo $agents->agents_position ?>"/>
									 </div>
								 </div>
								 ...
								 <div class="form-group" id="person_charge">
									 ...
									 <div class="col-sm-8">
									 <input class="form-control" placeholder="Enter person charge" name="agents_person_charge" id="agents_person_charge" type="text"  value="<?php echo $agents->agents_person_charge ?>"/>
									 </div>
								 </div>
								 ...
								 <div class="form-group" id="person_charge_contact_number">
									 ...
									 <div class="col-sm-8">
									 <input class="form-control" placeholder="Enter person in charge contact number" name="agents_person_charge_contact_number" id="agents_person_charge_contact_number" type="text" value="<?php echo $agents->agents_person_charge_contact_number ?>"/>
									 </div>
								 </div>
                                 ...
                                 <div class="form-group">
									 ...
									 <div class="col-sm-8">
									 <input class="form-control" name="agents_address" placeholder="Enter full address" id="agents_address"  type="text" value="<?php echo $agents->agents_address ?>">
									 </div>
								 </div>
                                 ...
                                 <div class="form-group ">
									...
									<select name="agents_country" id="agents_country" class="form-control select2" >
										...
										<?php foreach($country as $new) {
											$sel = "";
												if($new-country_id==$agents->agents_country) $sel='selected="selected"';
                                ...
                                <div class="form-group">
									 ...
									 <div class="col-sm-8">
									 <input class="form-control" id="agents_phone" name="agents_phone" placeholder="Enter phone"  type="text" value="<?php echo $agents->agents_phone ?>" >
									 </div>
								 </div>
								 ...
								 <div class="form-group">
									<label for="exampleInputEmail_4" class="col-sm-3 control-label">Account no.</label>
									 <div class="col-sm-8">
										 <input class="form-control" id="agents_account_no" name="agents_account_no" placeholder="Enter account no." value="<?php echo $agents->agents_account_no ?>" type="text" >
									 </div>
								 </div>
								  ...
								  <div class="form-group">
									 ...
									 <div class="col-sm-8">
									 <input class="form-control" id="agents_paypal" name="agents_paypal" placeholder="Enter paypal email (if available)" value="<?php echo $agents->agents_paypal ?>" type="text" >
									 </div>
								 </div>
								  ...
								  <div class="form-group">
									 ...
									 <div class="col-sm-8">
									 <input class="form-control" name="agents_account_name" id="agents_account_name" placeholder="Enter account name" value="<?php echo $agents->agents_account_name ?>" type="text" >
									 </div>
								 </div>
								   ...
								   <div class="form-group" >
									 ...
									 <div class="col-sm-8">
									 <input class="form-control" id="agents_swift" name="agents_swift" placeholder="Enter swift code"  type="text" value="<?php echo $agents->agents_swift ?>"  >
									 </div>
								 </div>
								  ...
								  <div class="form-group">
									 ...
									 <div class="col-sm-8">
									 <input class="form-control" id="agents_bank_name" name="agents_bank_name"  placeholder="Enter bank name" value="<?php echo $agents->agents_bank_name ?>" type="text" >
									 </div>
								 </div>
