												 ...
												 <?php if(isset($send)):?>
                            						<?php $ff=''; $i=1;foreach ($send as $new){
														...
														<tr <?php echo $not_view_from;?> <?php echo $ff;?> onclick="is_from_view(<?php echo $new->messages_id?>)" >
                                                            ...
                                                            <td class="inbox-small-cells"  onclick="is_from_view(<?php echo $new->messages_id?>)">
																<div class="checkbox checkbox-default inline-block">
															...
															<td class="view-message  dont-show"  onclick="is_from_view(<?php echo $new->messages_id?>)">
																<a href="<?php echo site_url('admin/messages/details/'.$new->messages_guid); ?>">
																	<?php if($new->admin_role == 1){echo 'Admin'; } else if($new->admin_role == 2) { 
																	$CI = get_instance();
																	$CI->load->model("students_model");
																$agent = $CI->students_model->get_agent($new->admin_guid);
																	...
																	<?php echo $neww; ?></a></td>
															<td class="view-message "  onclick="is_from_view(<?php echo $new->messages_id?>)">
                                                                <a href="<?php echo site_url('admin/messages/details/'.$new->messages_guid); ?>">
                                                                    <?php echo $new->messages_title ?></a></td>
															<td class="view-message  text-right"  onclick="is_from_view(<?php echo $new->messages_id?>)">
																<a href="<?php echo site_url('admin/messages/details/'.$new->messages_guid); ?>">
																<span  class="time-chat-history inline-block"><?php echo $new->message_created_on ?></span></a>
															</td>
														</tr>
													<?php $i++;}?>
												<?php endif;?>		
