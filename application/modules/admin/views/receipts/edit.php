					 ...
					 <div class="form-wrap">
                        <form id="fas_form" method="post" enctype="multipart/form-data"  action="">
							 <div class="form-horizontal">
									 ...
									 <div class="col-sm-8">
                                         <select name="receipts_university" class="form-control select2" >
                                             ...
                                             <?php foreach($univerity as $new) {
                                                 $sel = "";
                                                 if($new->university_id==$receipts->receipts_university) $sel='selected="selected"';
                                 ...
                                 <div class="form-group ">
	 								<label for="exampleInputEmail_4" class="col-sm-3 control-label">Payment status</label>
									 <div class="col-sm-8">
                                 ...
                                 <div class="form-group">
									 <label for="exampleInputuname_4" class="col-sm-3 control-label">Payment</label>
									 <div class="col-sm-8">
									 <input class="form-control" name="receipts_fund" placeholder="Enter payment" id="users_whatapp"  type="text" value="<?php echo $receipts->receipts_fund ?>" >
									 </div>
								 </div>
