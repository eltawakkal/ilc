		...
		<div class="fixed-sidebar-left">
			<ul class="nav navbar-nav side-nav nicescroll-bar">
				...
				<li><hr class="light-grey-hr mb-10"/></li>
				 ...
				 <li>
					 <a class="<?php echo($this->uri->segment(2)=='commission' )?'active':'';?>" href="<?php echo site_url('admin/commission');?>"><div class="pull-left">RM<span class="mr-20 "></span><span class="right-nav-text">Commission</span></div><div class="clearfix"></div></a>
				</li>
