...
class messages extends MX_Controller {
 ...
 (replys_guid,replys_msg_id,replys_text,replys_from,replys_to,replys_is_view_to,replys_is_view_from,replys_created_on) values('$replys_guid','$replys_msg_id','$replys_text','$admin_guid','$row->admin_guid','0','0','$replys_created_on')");
		...
		$CI->db->query("insert into replys_tb 
 (replys_guid,replys_msg_id,replys_text,replys_from,replys_to,replys_is_view_to,replys_is_view_from,replys_created_on) values('$replys_guid','$replys_msg_id','$replys_text','$admin_guid','$replys_to','0','0','$replys_created_on')");
	}
