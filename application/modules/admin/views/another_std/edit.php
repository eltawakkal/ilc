...
<section class="content-header">
    ...
    <ol class="breadcrumb">
        ...
        <li><a href="<?php echo site_url('admin/employees')?>"><?php echo lang('clients')?></a></li>
                        ...
                        <div class="form-group">
                        	<div class="row">
                                <div class="col-md-4">
									...
									<input type="text" name="admin_name" value="<?php echo $employees->admin_name?>" class="form-control">
                                </div>
                            </div>
                        </div>
						   ...
						   <div class="form-group">
                              <div class="row">
                                <div class="col-md-4">
                                    <label for="email" style="clear:both;"><?php echo lang('admin_role');?></label>
									<select name="admin_role" class="form-control chzn">
										<option value="">--<?php echo lang('select');?> <?php echo lang('admin_role');?>---</option>
                        ...
                        <div class="form-group">
                              <div class="row">
                                <div class="col-md-4">
									...
									<input type="text" name="admin_email" value="<?php echo $employees->admin_email?>" class="form-control">
                                </div>
                            </div>
                        </div>
						...
						<div class="form-group">
                              <div class="row">
                                <div class="col-md-4">
									...
									<input type="text" name="admin_username" value="<?php echo $employees->admin_username?>" class="form-control">
                                </div>
                            </div>
                        </div>
						...
						<div class="form-group">
                              <div class="row">
                                <div class="col-md-4">
									...
									<input type="password" name="admin_confirm" value="" class="form-control">
                                </div>
                            </div>
                        </div>
						 ...
						 <div class="form-group">
                              <div class="row">
                                <div class="col-md-4">
									...
									<input type="text" name="admin_phone" value="<?php echo $employees->admin_phone?>" class="form-control">
                                </div>
                            </div>
                        </div>
						 ...
						 <div class="form-group">
                              <div class="row">
                                <div class="col-md-4">
									...
									<textarea name="admin_address"  class="form-control"><?php echo $employees->admin_address?></textarea>
                                </div>
                            </div>
                        </div>
					<?php 
